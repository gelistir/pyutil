...
from pyutil.sql.models import Frame, Symbol, SymbolGroup, Field, PortfolioSQL, Strategy, _SymbolReference, FieldType
...
class TestModels(TestCase):
    def test_type_3(self):
        f = Field(name="A", _id= 10, type=FieldType.dynamic)
