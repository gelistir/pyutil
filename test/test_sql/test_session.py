...
class TestSession(TestCase):
    ...
    def test_timeseries_1(self):
        ...
        s.timeseries["wurst"] = {pd.Timestamp("2010-01-01").date(): 2.0, pd.Timestamp("2010-01-02").date(): 3.0,
        ...
        pdt.assert_series_equal(s.timeseries["wurst"], pd.Series(
            {pd.Timestamp("2010-01-01").date(): 2.0, pd.Timestamp("2010-01-02").date(): 3.0,
             pd.Timestamp("2010-01-04").date(): 5.0}))
