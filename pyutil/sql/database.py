...
# from pyutil.sql.models import ProductInterface
...
#     #     if names:
#     #         return {name: self.__session.query(_Portfolio).filter_by(name=name).one() for name in names}
#     #     else:
#     #         return {portfolio.name: portfolio for portfolio in self.__session.query(_Portfolio)}
#
